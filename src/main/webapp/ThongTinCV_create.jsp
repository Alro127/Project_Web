					...
					<% UngVien uv = (UngVien) request.getAttribute("uv"); %>
						...
						<div class="container text-center mt-4">
							<div class="position-relative d-inline-block">
								<!-- Avatar -->
								<img id="avatarPreview" src="<%=uv.getAvatar()%>"
									alt="Avatar" class="rounded-circle border"
									style="width: 200px; height: 200px; object-fit: cover;">
							</div>

							<!-- Tên nằm dưới avatar -->
							<h2 class="mt-3"><%= uv.getFullName() %></h2>
							</div>
							<!-- Vị trí ứng tuyển -->
							<div class="mb-3">
							...
							<div class="mb-3 personal-info">
								...
								<div class="mb-3">
									...
									<select id="gender" name="gender" class="form-select" disabled>
										<option value="<%=uv.getGender() %>" selected><%=uv.getGender() %></option>
									</select>
									<%} else { %>
								...
								<div class="mb-3">
									...
									<textarea id="introduction" name="introduction"
										class="form-control" rows="4" readonly><%=uv.getIntroduction()%> </textarea>
								</div>
