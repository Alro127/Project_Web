...
<div id="sidebar" class="sidebar d-flex flex-column bg-dark-blue ">
	...
	<a href="#" class="nav-link hover-coral"> <i
		...
		class="ms-4 py-2 fs-4 fw-bold bi bi-search"></i> <span>Tìm CV</span>
	</a> <a href="#" class="nav-link hover-coral"> <i
		class="ms-4 py-2 fs-4 fw-bold bi bi-briefcase"></i> <span>CV
			ứng tuyển</span>
	</a> <a href="#" class="nav-link hover-coral"> <i
		class="ms-4 py-2 fs-4 fw-bold bi bi-calendar-check"></i> <span>Lịch
			hẹn</span>
	</a> <a href="#" class="nav-link hover-coral"> <i
		class="ms-4 py-2 fs-4 fw-bold bi bi-person-gear"></i> <span>Quản lý
			tài khoản</span>
	</a>
