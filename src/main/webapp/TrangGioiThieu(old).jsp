...
<meta charset="UTF-8">
    <style>
      ...
      .job-card {
        ...
        position: relative; /* Đặt container thành phần tương đối để icon có thể định vị tuyệt đối */
        padding: 20px;
  ...
  <body>
    <header>
      ...
      <nav>
        ...
        <a href="#employers">Nhà tuyển dụng</a>
      </nav>
    </header>
    ...
    <main>
      ...
      <div class="jobs-container">
        <div class="job-card">  
            ...
            <img class="logo-company" src="anh.jpg" alt="Marketing" />
            <div class="job-card-body">
              <label class = "lbl-company-name">Tên công việc</label>
              <br>
